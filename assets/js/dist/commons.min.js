...
!(function () {
  ...
  const j = {
    ...
    off(t, e, n, i) {
      ...
      const [o, r, s] = x(e, n, i),
        ...
        u = e.startsWith('.');
      if (void 0 === r) {
        if (u) for (const n of Object.keys(c)) L(t, c, n, e.slice(1));
  ...
  const z = (t) => {
    ...
    W = {
      ...
      getSelectorFromElement(t) {
        const e = z(t);
        return e && W.findOne(e) ? e : null;
      },
      getElementFromSelector(t) {
        const e = z(t);
        return e ? W.findOne(e) : null;
      },
    ...
    R = '.'.concat('bs.collapse'),
    q = 'show'.concat(R),
    V = 'shown'.concat(R),
    Y = 'hide'.concat(R),
    U = 'hidden'.concat(R),
    K = 'click'.concat(R).concat('.data-api'),
    Q = 'show',
    X = 'collapse',
    $ = 'collapsing',
  ...
  class et extends H {
    constructor(t, e) {
      ...
      const n = W.find(J);
      for (const t of n) {
        const e = W.getSelectorFromElement(t),
          n = W.find(e).filter((t) => t === this._element);
    ...
    show() {
      ...
      if (
        ...
        return;
      if (j.trigger(this._element, q).defaultPrevented) return;
    ...
    hide() {
      ...
      for (const t of this._triggerArray) {
        const e = W.getElementFromSelector(t);
    ...
    _initializeChildren() {
      ...
      for (const e of t) {
        const t = W.getElementFromSelector(e);
        t && this._addAriaAndCollapsedClass([e], this._isShown(t));
      }
    }
    _getFirstLevelChildren(t) {
      const e = W.find(G, this._config.parent);
      return W.find(t, this._config.parent).filter((t) => !e.includes(t));
    }
  ...
  var nt = 'top',
    ...
    gt = [].concat(at, [st]).reduce(function (t, e) {
  ...
  function Ft(t, e, n) {
    ...
    var s = (Tt(t) ? Lt(t) : window).visualViewport,
      a = !It() && n,
  ...
  function Vt(t) {
    return 'html' === Ct(t)
      ? t
      : t.assignedSlot || t.parentNode || (St(t) ? t.host : null) || qt(t);
  }
  function Yt(t) {
    return jt(t) && 'fixed' !== Wt(t).position ? t.offsetParent : null;
  }
  function Ut(t) {
    for (var e = Lt(t), n = Yt(t); n && Rt(n) && 'static' === Wt(n).position; )
      n = Yt(n);
    return n &&
      ('html' === Ct(n) || ('body' === Ct(n) && 'static' === Wt(n).position))
      ? e
      : n ||
          (function (t) {
            var e = /firefox/i.test(Bt());
            if (/Trident/i.test(Bt()) && jt(t) && 'fixed' === Wt(t).position)
              return null;
            var n = Vt(t);
            for (
              St(n) && (n = n.host);
  ...
  function le(t) {
    return Ft(qt(t)).left + ce(t).scrollLeft;
  }
  function ue(t) {
    var e = Wt(t),
      n = e.overflow,
          ...
          (function (t) {
            ...
            return (
              'rtl' === Wt(o || n).direction &&
                (a += Dt(n.clientWidth, o ? o.clientWidth : 0) - r),
    ...
    var o =
        'clippingParents' === e
          ? (function (t) {
              var e = de(Vt(t)),
                n =
                  ['absolute', 'fixed'].indexOf(Wt(t).position) >= 0 && jt(t)
                    ? Ut(t)
                    : t;
              return Tt(n)
                ? e.filter(function (t) {
                    return Tt(t) && zt(t, n) && 'body' !== Ct(t);
                  })
                : [];
            })(t)
          : [].concat(e),
  ...
  function ve(t, e) {
    ...
    var n = e,
      ...
      g = n.padding,
      m = void 0 === g ? 0 : g,
      v = Xt('number' != typeof m ? m : $t(m, at)),
      b = d === dt ? pt : dt,
      y = t.rects.popper,
      _ = t.elements[h ? b : d],
      w = ge(Tt(_) ? _ : _.contextElement || qt(t.elements.popper), c, u, s),
      E = Ft(t.elements.reference),
      O = me({ reference: E, element: y, strategy: 'absolute', placement: o }),
  ...
  var Ee = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        s = ve(e, { elementContext: 'reference' }),
  ...
  var Ae = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        h = n.tetherOffset,
        g = void 0 === h ? 0 : h,
        m = ve(e, { boundary: c, rootBoundary: l, padding: f, altBoundary: u }),
        v = Pt(e.placement),
        b = Jt(e.placement),
        y = !b,
        _ = Kt(v),
      ...
      if (E) {
        if (r) {
          var j,
            ...
            q = W[k],
            V = Qt(0, O[P], z[P]),
            Y = y ? O[P] / 2 - B - V - R - C.mainAxis : I - V - R - C.mainAxis,
            U = y ? -O[P] / 2 + B + V + q + C.mainAxis : F + V + q + C.mainAxis,
            K = e.elements.arrow && Ut(e.elements.arrow),
            Q = K ? ('y' === _ ? K.clientTop || 0 : K.clientLeft || 0) : 0,
            X = null != (j = null == L ? void 0 : L[_]) ? j : 0,
            $ = D + U - X,
            G = Qt(p ? Mt(M, D + Y - X - Q) : M, D, p ? Dt(N, $) : N);
          (E[_] = G), (T[_] = G - D);
        }
        if (a) {
          var J,
            ...
            at = et + m[Z],
            lt = et - m[tt],
            ut = -1 !== [nt, rt].indexOf(v),
            ft = null != (J = null == L ? void 0 : L[w]) ? J : 0,
  ...
  var ke = Se(),
    Pe = Se({ defaultModifiers: [ie, xe, ee, kt] }),
    De = Se({ defaultModifiers: [ie, xe, ee, kt, Oe, ye, Ae, Gt, Ee] }),
    Me = Object.freeze({
      __proto__: null,
      afterMain: wt,
      afterRead: bt,
  ...
  class Re extends F {
    ...
    _checkContent(t) {
      for (const [e, n] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: n }, We);
    }
    _setContent(t, e, n) {
  ...
  class tn extends H {
    ...
    _createPopper(t) {
      const e = d(this._config.placement, [this, t, this._element]),
        n = Ge[e.toUpperCase()];
      return De(this._element, t, this._getPopperConfig(n));
    }
    _getOffset() {
    ...
    _getConfig(t) {
      ...
      for (const t of Object.keys(e)) qe.has(t) && delete e[t];
      return (
  ...
  var en;
  f(tn);
  const nn = document.getElementById('toc-bar'),
    on = document.getElementById('toc-solo-trigger'),
    rn = document.getElementsByClassName('toc-trigger'),
    sn = document.getElementById('toc-popup'),
    an = document.getElementById('toc-popup-close'),
    cn = 'overflow-hidden',
    ln = 'closing';
  class un {
    static initBar() {
      new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            nn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(k(un, this, dn)._, 'px 0px 0px 0px') }
      ).observe(on),
        (fn._ = k(un, this, !1));
    }
    ...
    static refresh() {
      k(un, this, fn)._ && this.initComponents(),
    ...
    static showPopup() {
      this.lockScroll(!0), sn.showModal();
      sn.querySelector('li.is-active-li').scrollIntoView({ block: 'center' });
    }
    static hidePopup() {
      sn.toggleAttribute(ln),
        sn.addEventListener(
          'animationend',
          () => {
            sn.toggleAttribute(ln), sn.close();
          },
          { once: !0 }
        ),
        this.lockScroll(!1);
    ...
    static lockScroll(t) {
      document.documentElement.classList.toggle(cn, t),
        document.body.classList.toggle(cn, t);
    }
    static clickBackdrop(t) {
      if (sn.hasAttribute(ln)) return;
    ...
    static initComponents() {
      this.initBar(),
        ...
        (sn.onclick = (t) => this.clickBackdrop(t)),
        (an.onclick = () => this.hidePopup()),
        (sn.oncancel = (t) => {
  ...
  P(un, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: k((en = un), en, dn)._
  });
  P(
    class {
      static refresh() {
  ...
  const hn = document.getElementById('sidebar'),
    gn = document.getElementById('sidebar-trigger'),
    mn = document.getElementById('mask');
  class vn {
    static toggle() {
      (bn._ = k(vn, this, !k(vn, this, bn)._)),
        document.body.toggleAttribute('sidebar-display', k(vn, this, bn)._),
        hn.classList.toggle('z-2', k(vn, this, bn)._),
        mn.classList.toggle('d-none', !k(vn, this, bn)._);
    }
  }
  var bn = { _: !1 };
  const yn = document.getElementById('sidebar-trigger'),
    _n = document.getElementById('search-trigger'),
    wn = document.getElementById('search-cancel'),
    En = document.querySelectorAll('#main-wrapper>.container>.row'),
    On = document.getElementById('topbar-title'),
    xn = document.getElementById('search'),
    An = document.getElementById('search-result-wrapper'),
    Cn = document.getElementById('search-results'),
    Ln = document.getElementById('search-input'),
  ...
  class Dn {
    ...
    static off() {
      wn.classList.remove(jn),
        xn.classList.remove(Pn),
        yn.classList.remove(Sn),
        On.classList.remove(Sn),
        _n.classList.remove(Sn);
    }
  }
  class Mn {
    static on() {
      this.resultVisible ||
        (An.classList.remove(Sn),
        En.forEach((t) => {
          t.classList.add(Sn);
        }),
  ...
  function Nn() {
    return wn.classList.contains(jn);
  }
  P(Mn, 'resultVisible', !1),
    (gn.onclick = mn.onclick = () => vn.toggle()),
    _n.addEventListener('click', () => {
      Dn.on(), Mn.on(), Ln.focus();
    }),
    wn.addEventListener('click', () => {
      Dn.off(), Mn.off();
    }),
    Ln.addEventListener('focus', () => {
      xn.classList.add(kn);
    }),
    Ln.addEventListener('focusout', () => {
      xn.classList.remove(kn);
    }),
