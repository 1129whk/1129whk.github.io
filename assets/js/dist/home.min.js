...
!(function () {
    ...
    const f = w(s, e.replace(h, '')),
      d = r
            ...
            return function i(o) {
              ...
              for (let { target: s } = o; s && s !== this; s = s.parentNode)
                for (const a of r)
                  if (a === s)
                    return (
                      S(o, { delegateTarget: s }),
                      i.oneOff && j.off(t, o.type, e, n),
                      n.apply(s, [o])
                    );
            };
          })(t, n, s)
        : (function (t, e) {
            return function n(i) {
              return (
                S(i, { delegateTarget: t }),
                n.oneOff && j.off(t, i.type, e),
                e.apply(t, [i])
              );
            };
          })(t, s);
  ...
  const j = {
    ...
    trigger(t, e, n) {
      ...
      const l = S(new Event(e, { bubbles: r, cancelable: !0 }), n);
      return (
        a && l.preventDefault(),
        s && t.dispatchEvent(l),
  ...
  const F = {
    ...
    getDataAttribute: (t, e) => N(t.getAttribute('data-bs-'.concat(B(e))))
  };
  class I {
    static get Default() {
      return {};
    ...
    _mergeConfigObj(t, e) {
      const n = o(e) ? F.getDataAttribute(e, 'config') : {};
      return M(
        M(
          M(M({}, this.constructor.Default), 'object' == typeof n ? n : {}),
  ...
  class et extends H {
    ...
    show() {
      ...
      if (
        ...
        return;
      if (j.trigger(this._element, R).defaultPrevented) return;
      ...
      this._queueCallback(
        () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(X, Q),
            (this._element.style[e] = ''),
            j.trigger(this._element, V);
        },
        this._element,
        !0
      ),
    ...
    hide() {
      if (this._isTransitioning || !this._isShown()) return;
      if (j.trigger(this._element, Y).defaultPrevented) return;
      ...
      (this._element.style[t] = ''.concat(
        ...
        this._element.classList.add($),
        this._element.classList.remove(X, Q);
    ...
    _getFirstLevelChildren(t) {
      const e = q.find(G, this._config.parent);
  ...
  function It(t, e, n) {
    ...
    e &&
      jt(t) &&
      ((o = (t.offsetWidth > 0 && Nt(i.width) / t.offsetWidth) || 1),
      (r = (t.offsetHeight > 0 && Nt(i.height) / t.offsetHeight) || 1));
  ...
  function Yt(t) {
    return jt(t) && 'fixed' !== qt(t).position ? t.offsetParent : null;
  }
  function Ut(t) {
    for (var e = Tt(t), n = Yt(t); n && Wt(n) && 'static' === qt(n).position; )
      n = Yt(n);
    return n &&
      ('html' === Ct(n) || ('body' === Ct(n) && 'static' === qt(n).position))
      ? e
      : n ||
          (function (t) {
            var e = /firefox/i.test(Bt());
            if (/Trident/i.test(Bt()) && jt(t) && 'fixed' === qt(t).position)
              return null;
            var n = Vt(t);
            for (
              St(n) && (n = n.host);
              jt(n) && ['html', 'body'].indexOf(Ct(n)) < 0;
      ...
      T =
        !0 === u
          ? (function (t, e) {
              ...
              return { x: Nt(n * o) / o || 0, y: Nt(i * o) / o || 0 };
            })({ x: p, y: m }, Tt(n))
          : { x: p, y: m };
    return (
      (p = T.x),
  ...
  function le(t) {
    return It(Rt(t)).left + ce(t).scrollLeft;
  }
  function ue(t) {
    var e = qt(t),
      n = e.overflow,
    ...
    var o =
        'clippingParents' === e
          ? (function (t) {
              var e = de(Vt(t)),
                n =
                  ['absolute', 'fixed'].indexOf(qt(t).position) >= 0 && jt(t)
                    ? Ut(t)
                    : t;
              return Lt(n)
                ? e.filter(function (t) {
                    return Lt(t) && zt(t, n) && 'body' !== Ct(t);
                  })
                : [];
            })(t)
          : [].concat(e),
      ...
      a = r.reduce(function (e, n) {
        ...
        return (
          ...
          (e.right = Mt(o.right, e.right)),
          (e.bottom = Mt(o.bottom, e.bottom)),
      ...
      if (E) {
        if (r) {
          var j,
            ...
            R = q[D],
            V = Qt(0, O[k], z[k]),
            Y = y ? O[k] / 2 - B - V - W - C.mainAxis : F - V - W - C.mainAxis,
            U = y ? -O[k] / 2 + B + V + R + C.mainAxis : I + V + R + C.mainAxis,
            K = e.elements.arrow && Ut(e.elements.arrow),
            Q = K ? ('y' === _ ? K.clientTop || 0 : K.clientLeft || 0) : 0,
            X = null != (j = null == T ? void 0 : T[_]) ? j : 0,
            $ = P + U - X,
            G = Qt(p ? Mt(M, P + Y - X - Q) : M, P, p ? Pt(N, $) : N);
          (E[_] = G), (L[_] = G - P);
        }
        if (a) {
          var J,
            ...
            dt = ut ? at : et - O[st] - x[st] - ft + C.altAxis,
            pt = ut ? et + O[st] + x[st] - ft - C.altAxis : lt,
            ht =
              p && ut
                ? (function (t, e, n) {
                    var i = Qt(t, e, n);
      ...
      s =
        ...
        (function (t) {
          var e = t.getBoundingClientRect(),
            n = Nt(e.width) / t.offsetWidth || 1,
            i = Nt(e.height) / t.offsetHeight || 1;
          return 1 !== n || 1 !== i;
        })(e),
      a = Rt(e),
      c = It(t, s, n),
        ...
        (('body' !== Ct(e) || ue(a)) &&
          (l =
            (i = e) !== Tt(i) && jt(i)
              ...
              : ce(i)),
        jt(e)
          ? (((u = It(e, !0)).x += e.clientLeft), (u.y += e.clientTop))
          : a && (u.x = le(a))),
      {
  ...
  var De = Se(),
    ke = Se({ defaultModifiers: [ie, xe, ee, Dt] }),
    Pe = Se({ defaultModifiers: [ie, xe, ee, Dt, Oe, ye, Ae, Gt, Ee] }),
    Me = Object.freeze({
      __proto__: null,
      afterMain: wt,
      afterRead: vt,
  ...
  const Ne = {
    ...
    Fe = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,
    Ie = (t, e) => {
      const n = t.nodeName.toLowerCase();
      return e.includes(n)
        ? !Be.has(n) || Boolean(Fe.test(t.nodeValue))
  ...
  class We extends I {
    ...
    changeContent(t) {
      return (
        ...
        (this._config.content = M(M({}, this._config.content), t)),
        this
      );
    }
    toHtml() {
    ...
    _checkContent(t) {
      for (const [e, n] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: n }, qe);
    }
    _setContent(t, e, n) {
      const i = q.findOne(n, t);
      i &&
        ...
        ? (function (t, e, n) {
            ...
            for (const t of o) {
              ...
              const i = [].concat(...t.attributes),
                o = [].concat(e['*'] || [], e[n] || []);
              for (const e of i) Ie(e, o) || t.removeAttribute(e.nodeName);
            }
  ...
  class tn extends H {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(Ke), Qe, this._hideModalHandler),
    ...
    _getPopperConfig(t) {
      ...
      return M(M({}, e), d(this._config.popperConfig, [e]));
    }
    _setListeners() {
      ...
      for (const e of t)
        if ('click' === e)
          ...
          j.on(this._element, t, this._config.selector, (t) => {
            ...
            (e._activeTrigger['focusin' === t.type ? $e : Xe] = !0), e._enter();
          }),
            j.on(this._element, n, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger['focusout' === t.type ? $e : Xe] =
      ...
      (this._hideModalHandler = () => {
        ...
        j.on(this._element.closest(Ke), Qe, this._hideModalHandler);
    }
    _fixTitle() {
  ...
  function an() {
    this.complete &&
      (this.hasAttribute(nn) ? sn.call(this, rn) : sn.call(this, on));
  }
  function cn() {
    const t = this.getAttribute(en);
    this.setAttribute('src', encodeURI(t)), this.removeAttribute(en);
  }
  class ln {
  ...
  var un;
  const fn = document.getElementById('toc-bar'),
    dn = document.getElementById('toc-solo-trigger'),
    pn = document.getElementsByClassName('toc-trigger'),
    hn = document.getElementById('toc-popup'),
    mn = document.getElementById('toc-popup-close'),
    gn = 'overflow-hidden',
    bn = 'closing';
  class vn {
    static initBar() {
      new IntersectionObserver(
        (t) => {
          t.forEach((t) => {
            fn.classList.toggle('invisible', t.isIntersecting);
          });
        },
        { rootMargin: '-'.concat(D(vn, this, _n)._, 'px 0px 0px 0px') }
      ).observe(dn),
        (yn._ = D(vn, this, !1));
    }
    ...
    static refresh() {
      D(vn, this, yn)._ && this.initComponents(),
    ...
    static showPopup() {
      this.lockScroll(!0), hn.showModal();
      hn.querySelector('li.is-active-li').scrollIntoView({ block: 'center' });
    }
    static hidePopup() {
      hn.toggleAttribute(bn),
        hn.addEventListener(
          'animationend',
          () => {
            hn.toggleAttribute(bn), hn.close();
          },
          { once: !0 }
        ),
        this.lockScroll(!1);
    ...
    static lockScroll(t) {
      document.documentElement.classList.toggle(gn, t),
        document.body.classList.toggle(gn, t);
    }
    static clickBackdrop(t) {
      if (hn.hasAttribute(bn)) return;
    ...
    static initComponents() {
      this.initBar(),
        ...
        (hn.onclick = (t) => this.clickBackdrop(t)),
        (mn.onclick = () => this.hidePopup()),
        (hn.oncancel = (t) => {
  ...
  k(vn, 'options', {
    ...
    scrollSmooth: !1,
    collapseDepth: 4,
    headingsOffset: D((un = vn), un, _n)._
  });
  k(
    class {
      static refresh() {
  ...
  const wn = document.getElementById('mode-toggle');
  const En = document.getElementById('sidebar'),
    On = document.getElementById('sidebar-trigger'),
    xn = document.getElementById('mask');
  class An {
    static toggle() {
      (Cn._ = D(An, this, !D(An, this, Cn)._)),
        document.body.toggleAttribute('sidebar-display', D(An, this, Cn)._),
        En.classList.toggle('z-2', D(An, this, Cn)._),
        xn.classList.toggle('d-none', !D(An, this, Cn)._);
    }
  }
  var Cn = { _: !1 };
  const Tn = document.getElementById('sidebar-trigger'),
    Ln = document.getElementById('search-trigger'),
    jn = document.getElementById('search-cancel'),
    Sn = document.querySelectorAll('#main-wrapper>.container>.row'),
    Dn = document.getElementById('topbar-title'),
    kn = document.getElementById('search'),
    Pn = document.getElementById('search-result-wrapper'),
    Mn = document.getElementById('search-results'),
    Nn = document.getElementById('search-input'),
    Bn = document.getElementById('search-hints'),
    Fn = 'd-block',
    In = 'd-none',
    Hn = 'input-focus',
    zn = 'd-flex';
  class qn {
    ...
    static off() {
      jn.classList.remove(Fn),
        kn.classList.remove(zn),
        Tn.classList.remove(In),
        Dn.classList.remove(In),
  ...
  class Wn {
    ...
    static off() {
      this.resultVisible &&
        ((Mn.innerHTML = ''),
        Bn.classList.contains(In) && Bn.classList.remove(In),
        Pn.classList.add(In),
        Sn.forEach((t) => {
  ...
  function Rn() {
    return jn.classList.contains(Fn);
  }
  k(Wn, 'resultVisible', !1),
    (function () {
      const t = document.querySelectorAll('article img');
      if (0 === t.length) return;
      t.forEach((t) => {
        t.addEventListener('load', an);
      }),
        document
          .querySelectorAll('article img[loading="lazy"]')
          .forEach((t) => {
            t.complete && sn.call(t, on);
          });
      const e = document.querySelectorAll(
        'article img['.concat(nn, '="true"]')
      );
      e.length &&
        e.forEach((t) => {
          cn.call(t);
    ...
    dayjs.locale(ln.locale),
    dayjs.extend(window.dayjs_plugin_localizedFormat),
    document
      .querySelectorAll('['.concat(ln.attrTimestamp, ']'))
      .forEach((t) => {
        const e = dayjs.unix(ln.getTimestamp(t)),
          n = e.format(ln.getDateFormat(t));
        if (
          ((t.textContent = n),
          t.removeAttribute(ln.attrTimestamp),
          t.removeAttribute(ln.attrDateFormat),
    ...
    (On.onclick = xn.onclick = () => An.toggle()),
    Ln.addEventListener('click', () => {
      qn.on(), Wn.on(), Nn.focus();
    }),
    ...
    Nn.addEventListener('focusout', () => {
      kn.classList.remove(Hn);
    }),
    Nn.addEventListener('input', () => {
      '' === Nn.value
        ? Rn()
          ? Bn.classList.remove(In)
          : Wn.off()
        : (Wn.on(), Rn() && Bn.classList.add(In));
    }),
    wn &&
